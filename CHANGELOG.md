...
- Adding missing properties and returned types to the documentation.
- Including more information to the demo page.
- Adding required configuration to deploy demo page to Github pages.
- Removing references to Travis.
...
## [0.0.11] - 2019-03-04
- Minor fix to properly manage native HTML player.
